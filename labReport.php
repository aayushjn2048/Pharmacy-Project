...
<head>
    ...
    <script type = "text/javascript">
            function funcPat(idpatient){
                location.href = "appointment.php?idpatient="+idpatient;
            }
            function goback()
            {
                window.history.back();
            }
            function viewMyReport(appointmentId)
            {
                location.href = "viewReports.php?appointmentId="+appointmentId;
            }
    </script>
</head>
<body>
    <div class="container-fluid px-3">
        ...
        <div style = "position: absolute; float:left;">
            ...
            <div class="topnav" style = "margin-left: 3.8em;">
                ...
                <a style = "padding-top: 5px; padding-bottom: 5px;" class="active" href="labReport.php">Lab Reports</a>
        ...
        <div class="main-content">
            ...
            <?php require_once 'connectDB.php';?>
                ...
                <div class="col col-sm-12 col-md-6 col-xl-4 mt-5">
                    <h5>View Lab Reports</h5>
                    <?php
                        $x=mysqli_query($con,"  SELECT *
                                                FROM labreport, patient
                                                WHERE labreport.patientId = patient.idpatient");
                        if ($x->num_rows > 0) 
                        {
                            //echo $x->num_rows;
                            while($row = $x->fetch_assoc()) 
                            {
                                ...
                                echo '  <style>
                                        ...
                                        <div class="card" onclick = "viewMyReport('.$row["appointmentId"].')">
                                            <div class="row">
                                                <div class="col col-2" style="margin: 0.5em;">';
                                ...
                                echo               '</span>
                                                ...
                                                <div class="col col-7" style="margin: auto;">
                                                    ...
                                                    <p style="margin: 0; font-size: 0.7em;">Appointment Id: '.$row["appointmentId"].'</p>
                                                    </div>
                                                </div>
                                            </div>';
                            }
                        } else {
                            echo "No reports registered to the server";
                        }
                    ?>
                </div>
            </div>
